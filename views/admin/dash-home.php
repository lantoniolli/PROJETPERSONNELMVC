...
<div class="page-content p-5" id="content">
        <!-- Toggle button -->
        <button id="sidebarCollapse" type="button" class="btn bg-dark rounded-pill shadow-sm px-2 mb-4"><i
                class="uil uil-maximize-left button__icon"></i></button>
            ...
            <div class="container d-flex flex-column">
                ...
                <div class="row d-flex justify-content-around mt-5">
                    ...
                    <div class="col-lg-5 block__test rounded shadow-lg">
                        ...
                        <div class="nav-item" id="text__dash">Gestion Privilèges</div>
                    </div>
                </div>
            </div>
