<div class="page-content p-5" id="content">
    ...
    <h2 class="display-4 title__dashboard">Modifier une Convention</h2>
        ...
        <div id="preview_img" style="width: 18rem;">
            ...
            <form action="" enctype="multipart/form-data" method="POST" class="row g-3 justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <input type="text" class="form-control" id="inputTitle" name="title" value="<?= $meeting->event_name ?>">
                </div>
                ...
                <div class="col-md-6 text-center">
                    ...
                    <input type="text" class="form-control" id="inputTitle" name="location" value="<?= $meeting->event_location ?>">
                </div>


                <div class="col-md-6 text-center">
                    <label for="formFileSm" class="form-label title__label">Date</label>
                    <input type="date" class="form-control" id="date" name="date" value="<?= $meeting->event_date ?>" required>
                </div>


                <div class="col-8 mt-3 text-center">
                    <label for="inputContent" class="form-label title__label">Contenu</label>
                    <textarea class="form-control" id="editor" name="content"><?= $meeting->event_description ?></textarea>
                </div>
                <div class="col-12 text-center mt-5">
                    <button type="submit" class="btn btn__color">Modifier</button>
                </div>
            </form>
        </div>
